...
sources = [CORE/f'{n}.swift' for n in ['Wire','Framebuffer','STT','DeveloperCrypto','CodexWire']]
sources += [APPLE/'FFSBridge/Services'/f'{n}.swift' for n in ['VoiceService','DeveloperServer','CodexRPC','CodexService']]
