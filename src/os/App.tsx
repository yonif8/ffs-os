...
// FUT-217: rebuilt with the gesture_fwd input hooks removed (they killed the LEFT touchpad).
const LOADER_SHA = "bba1b4f3931c7803de6b00a26cd06b14ae96791edf40f1720bffd939b4493804";
